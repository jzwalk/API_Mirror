...
[Avartar](https://github.com/typecho/plugins/blob/master/Avartar.php) | 自定义替换Gravatar头像代理插件 | 0.6.0 Beta | [loftor](https://github.com/loftor-git) | [下载](https://github.com/typecho-fans/plugins/releases/download/plugins-A_to_C/Avartar.zip)
...
[waterMark](https://github.com/internelp/waterMark) | 图片自动添加Gif/Png格式水印插件 | 0.5.1 | [应用侠](https://github.com/internelp) | [下载](https://github.com/typecho-fans/plugins/releases/download/plugins-S_to_Z/waterMark_应用侠.zip)
